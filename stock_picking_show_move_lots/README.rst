...
============================
Stock Picking Show Move Lots
============================

Show lots in the move lines of the stock picking form
...
#. Go to a stock picking form view. In the operations tab you will always see the "Lots/Serial Numbers" column
